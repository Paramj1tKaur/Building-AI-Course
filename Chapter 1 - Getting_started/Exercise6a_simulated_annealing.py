""" 1D simulated annealing: Program  use simulated annealing. In simulated annealing the probability of accepting a solution that lowers the score is given by prob = exp(-(S_old - S_new)/T). Setting the temperature T and gradually decreasing can be done in many ways, some of which lead to better outcomes than others. This program has used T = 2*max(0, ((steps-step*1.2)/steps))**3."""
