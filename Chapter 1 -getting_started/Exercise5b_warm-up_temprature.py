""" Program returns the probability of accepting the new state using simulated annealing. It takes the two score values (the current and the new) and the temperature value as arguments """
