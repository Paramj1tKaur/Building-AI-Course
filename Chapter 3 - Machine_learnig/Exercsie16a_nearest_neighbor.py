""" Nearest neighbor: classify the cabins based on their nearest neighbor's class. Predict the output class (y_predict) for each cabin in the test set based on the output class (y_train) of its nearest neighbor.
""" 
import math
import random
import numpy as np
